...
- Update CHANGELOG.md for release v2.0.0

- Add mtoc markdown table of contents generator
...
- Bump clap from 4.5.17 to 4.5.20
...
- Merge pull request #4 from containerscrew/dependabot/cargo/clap-4.5.20

Bump clap from 4.5.17 to 4.5.20

- Udate Cargo.toml

- Bump clap from 4.5.20 to 4.5.22

Bumps [clap](https://github.com/clap-rs/clap) from 4.5.20 to 4.5.22.
- [Release notes](https://github.com/clap-rs/clap/releases)
- [Changelog](https://github.com/clap-rs/clap/blob/master/CHANGELOG.md)
...
- Merge pull request #8 from containerscrew/dependabot/cargo/clap-4.5.22
...
- Merge pull request #6 from containerscrew/dependabot/cargo/openssl-0.10.68

Bump openssl from 0.10.66 to 0.10.68

- Bump clap from 4.5.22 to 4.5.29

Bumps [clap](https://github.com/clap-rs/clap) from 4.5.22 to 4.5.29.
- [Release notes](https://github.com/clap-rs/clap/releases)
- [Changelog](https://github.com/clap-rs/clap/blob/master/CHANGELOG.md)
- [Commits](https://github.com/clap-rs/clap/compare/clap_complete-v4.5.22...clap_complete-v4.5.29)
...
- Merge pull request #18 from containerscrew/dependabot/cargo/openssl-0.10.70
...
- Merge pull request #12 from containerscrew/dependabot/cargo/git2-0.20.0

Bump git2 from 0.19.0 to 0.20.0

- Add auto merge pipeline

- Cargo update and remove openssl dependency
